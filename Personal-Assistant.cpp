...
void wishme(){
    ...
    if (time-> tm_hour < 12){
        ...
        cout<< "Good Evening Abhishek"<<endl;
        string phrase = "Good Evening Abhishek";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    do
    {
        ...
        if(strcmp(password, "abhi")==0){ 
            ...
            do{
                cout<<"\n<==================================================================================================>\n\n";
                cout<<endl<<"How can i help you Master Abhishek...."<<endl<<endl;

                string phrase = "How can i help you Master Abhishek";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
